...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawUSB(...params) {
    return this.forwardFunction(params, 'withdrawUSB(uint256,uint256,address,address)')
  }

  async repayUSB(...params) {
    return this.forwardFunction(params, 'repayUSB(uint256,address,address)')
  }
  ...
  async USB_GAS_COMPENSATION(...params) {
    return this.proxyFunction('USB_GAS_COMPENSATION', params)
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingUSBDebtReward(...params) {
    return this.proxyFunction('getPendingUSBDebtReward', params)
  }
  ...
  async L_USBDebt() {
    return this.proxyFunction('L_USBDebt', [])
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedUSBDeposit(user) {
    return this.proxyFunctionWithUser('getCompoundedUSBDeposit', user)
  }
...
class BLPYStakingProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token)
  }
  ...
  async F_USB(user) {
    return this.proxyFunctionWithUser('F_USB', user)
  }
}
