...
const BLPYStaking = artifacts.require("./BLPY/BLPYStaking.sol")
const BLPYToken = artifacts.require("./BLPY/BLPYToken.sol")
const LockupContractFactory = artifacts.require("./BLPY/LockupContractFactory.sol")
const CommunityIssuance = artifacts.require("./BLPY/CommunityIssuance.sol")
const HintHelpers = artifacts.require("./HintHelpers.sol")

const CommunityIssuanceTester = artifacts.require("./BLPY/CommunityIssuanceTester.sol")
...
async function main() {
  ...
  const BLPYContracts = await dh.deployBLPYContractsHardhat(ARBITRARY_ADDRESS, ARBITRARY_ADDRESS)
  ...
  console.log(`\n`)
  console.log(`BLPY CONTRACTS`)
  await logContractDeploymentCosts(BLPYContracts)
  console.log(`\n`)
  logContractBytecodeLengths(BLPYContractABIs)
  console.log(`\n`)
